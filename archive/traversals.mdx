...
Note:
- Combine traversals with [property access](https://helix-llms-txt.mintlify.app/properties.md#property-access) or [aggregation](https://helix-llms-txt.mintlify.app/aggregation.md) for richer results
