...
description: "Combine multiple conditions using AND and OR operators for complex filtering logic."
---
...
# Now get users between 18 and 30 (young adults)
...
# First create some users with varied data
users = [
    {"name": "Alice", "age": 25, "email": "alice@example.com"},
    {"name": "Bob", "age": 16, "email": "bob@example.com"},
...
# Get users named Alice or Bob who are older than 18
