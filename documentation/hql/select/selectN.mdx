...
<Note>You can also do specific property based filtering, e.g returning only ID, see the [Property Filtering](../steps/properties/property-access). You can also do aggregation steps, e.g returning the count of nodes, see the [Aggregations](../steps/aggregation).</Note>
