...
```
  ...
  <Note>
   If you already have the Helix CLI installed, you can update it with `helix update`.

   You can then migrate your project with `helix migrate`. See the [Migration Guide](/documentation/cli-v2/migration) for more information.
  </Note>
</Step>
