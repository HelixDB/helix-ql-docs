...
<Step title="(Optional) How do I add AI onboarding files?">

```bash
helix ai setup
```

Use `--agents all` to generate Cursor, Copilot, and Codex files in addition to Claude skills.

For full options, see [AI Setup](/documentation/cli-v2/ai-setup).
