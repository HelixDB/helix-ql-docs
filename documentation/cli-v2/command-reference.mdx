...
<ResponseField name="helix init [OPTIONS] [SUBCOMMAND]" >
    ...
    <ResponseField name="--ai" type="Boolean">
        Generate AI onboarding files after init.
    </ResponseField>
    <ResponseField name="--ai-agents [LIST]" type="String">
        Comma-separated agent targets for AI setup (`claude,cursor,copilot,codex,all`).
    </ResponseField>
    <ResponseField name="--ai-copy-prompt" type="Boolean">
        Copy the generated AI setup prompt to clipboard after init.
    </ResponseField>
    </Expandable>
...
Generate AI onboarding files and agent skills for your Helix project.

<ResponseField name="helix ai [SUBCOMMAND]">
  The subcommand to run.

  <Expandable title="subcommands">
    <ResponseField name="setup [OPTIONS]">
      Generate AI setup files.

      <Expandable title="options">
        <ResponseField name="--path, -p [PATH]" type="String">
          Target directory (defaults to project root when `helix.toml` is found).
        </ResponseField>
        <ResponseField name="--agents [LIST]" type="String">
          Comma-separated targets: `claude,cursor,copilot,codex,all`.
        </ResponseField>
        ...
        <ResponseField name="--copy-prompt" type="Boolean">
          Copy `HELIX_AI_SETUP_PROMPT.md` to clipboard.
        </ResponseField>
      </Expandable>
    </ResponseField>
  </Expandable>
