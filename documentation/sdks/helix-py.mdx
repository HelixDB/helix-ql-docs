...
## Queries
[**helix-py**](https://github.com/HelixDB/helix-py) allows users to define a a PyTorch-like manner, similar to how
...
## Instance
To setup a simple `Instance` that managges and automatically starts and stops a helix instance with respect
