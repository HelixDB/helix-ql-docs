...
Note:
- Combine traversals with [property access](https://helix-llms-txt.mintlify.app/llms/properties.md#property-access) or [aggregation](https://helix-llms-txt.mintlify.app/llms/aggregation.md) for richer results
