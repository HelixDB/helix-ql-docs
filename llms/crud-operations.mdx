...
##### Example 4: Using the built-in [`Embed` function](https://helix-llms-txt.mintlify.app/llms/vector.md#embedding-vectors-using-embed)
...
Notes:
- You can do [property filtering](https://helix-llms-txt.mintlify.app/llms/properties.md)
- You can do [conditional filtering](https://helix-llms-txt.mintlify.app/llms/conditionals.md)
- You can do [aggregation](https://helix-llms-txt.mintlify.app/llms/aggregation.md)
