...
Note: When using the [Python SDK](https://helix-llms-txt.mintlify.app/llms/sdks.md#python-sdk-helix-py-pypi), the return values are wrapped in an array for multiple query calls, so you will need to access the first element of the array to get the result of the first call.
