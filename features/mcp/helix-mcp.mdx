...
```
For more information about the embedder, see our [Helix Embedders](/documentation/sdks/helix-py#embedders) guide.
...
For more information about LLM providers, see our [Helix LLM Providers](/documentation/sdks/helix-py#providers) guide.
