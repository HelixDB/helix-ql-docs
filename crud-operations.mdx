...
##### Example 4: Using the built-in [`Embed` function](https://helix-llms-txt.mintlify.app/vector.md#embedding-vectors-using-embed)
...
Notes:
- You can do [property filtering](https://helix-llms-txt.mintlify.app/properties.md)
- You can do [conditional filtering](https://helix-llms-txt.mintlify.app/conditionals.md)
- You can do [aggregation](https://helix-llms-txt.mintlify.app/aggregation.md)
