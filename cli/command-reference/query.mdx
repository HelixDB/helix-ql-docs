...
- [`helix run`](/cli/command-reference/run) — start a local instance to query against
- [`helix sync`](/cli/command-reference/sync) — refresh V2 Cloud gateway/auth metadata
