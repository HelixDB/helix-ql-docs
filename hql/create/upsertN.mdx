...
- [Create nodes](/hql/create/addN) - Always create new nodes with AddN
- [Update nodes](/hql/updating) - Modify existing node properties
- [Upsert edges](/hql/create/upsertE) - Insert-or-update edges
- [Upsert vectors](/hql/create/upsertV) - Insert-or-update vectors
