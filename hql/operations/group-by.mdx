...
<CardGroup cols={2}>
  <Card title="Aggregations" icon="chart-column" href="/hql/operations/aggregate-by">
    Aggregate results with full data objects
  </Card>
  <Card title="Grouping Guide" icon="book" href="/hql/operations/grouping-guide">
    When to use GROUP_BY vs AGGREGATE_BY
  </Card>
  <Card title="COUNT Operation" icon="hashtag" href="/hql/result_ops">
    Count operation and other result operations
  </Card>
  <Card title="Property Access" icon="tag" href="/hql/properties/property-access">
