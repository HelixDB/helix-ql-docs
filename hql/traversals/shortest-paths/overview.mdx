...
<CardGroup cols={3}>
  <Card title="BFS" icon="diagram-project" href="/hql/traversals/shortest-paths/shortest-path-bfs">
    Unweighted shortest paths using breadth-first search
  </Card>
  <Card title="Dijkstra" icon="route" href="/hql/traversals/shortest-paths/shortest-path-dijkstra">
    Weighted shortest paths with custom weight calculations
  </Card>
  <Card title="A*" icon="star" href="/hql/traversals/shortest-paths/shortest-path-astar">
...
<CardGroup cols={2}>
  <Card title="Custom Weights" icon="scale-balanced" href="/hql/traversals/shortest-paths/custom-weights">
    Learn about property contexts and weight expressions
  </Card>
  <Card title="Advanced Expressions" icon="function" href="/hql/traversals/shortest-paths/weight-expressions">
    Compose complex mathematical weight calculations
  </Card>
  <Card title="Graph Traversals" icon="project-diagram" href="/hql/traversals/steps_edges">
    Other graph traversal operations
  </Card>
  <Card title="Mathematical Functions" icon="calculator" href="/hql/functions">
