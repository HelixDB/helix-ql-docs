...
<Note>
All mathematical functions available in Helix can be used in weight expressions. See the [Mathematical Functions](/hql/functions) reference for the complete list.
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="ShortestPathDijkstras" icon="route" href="/hql/traversals/shortest-paths/shortest-path-dijkstra">
    Dijkstra's algorithm documentation
  </Card>
  <Card title="Overview" icon="route" href="/hql/traversals/shortest-paths/overview">
