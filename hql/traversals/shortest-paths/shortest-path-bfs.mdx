...
<Note>
If edges have different weights (distance, cost, time), use [ShortestPathDijkstras](/hql/traversals/shortest-paths/shortest-path-dijkstra) instead.
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="ShortestPathAStar" icon="star" href="/hql/traversals/shortest-paths/shortest-path-astar">
