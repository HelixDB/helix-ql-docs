...
<Note>
Custom weights are available in both [ShortestPathDijkstras](/hql/traversals/shortest-paths/shortest-path-dijkstra) and [ShortestPathAStar](/hql/traversals/shortest-paths/shortest-path-astar).
</Note>
...
<CardGroup cols={2}>
  <Card title="Weight Expressions" icon="function" href="/hql/traversals/shortest-paths/weight-expressions">
