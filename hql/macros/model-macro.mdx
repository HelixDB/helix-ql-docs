...
<CardGroup cols={2}>
  <Card title="Embedding Vectors" href="/hql/vectors/embedding" icon="link">
    Learn how to use the Embed function for automatic text embedding
  </Card>
  <Card title="Vector Search" href="/hql/vectors/searching" icon="magnifying-glass">
    Perform similarity search on vector data
  </Card>
  <Card title="MCP Macro" href="/hql/macros/mcp-macro" icon="wand-magic-sparkles">
    Expose queries as MCP endpoints for AI agents
  </Card>
  <Card title="AddV" href="/hql/create/addV" icon="plus">
