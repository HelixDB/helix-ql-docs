...
<CardGroup cols={3}>
    <Card title="Deploy your first query" href="/cli/getting-started" icon="book-open">
        Learn how to deploy your first query in HelixQL.
    </Card>
    <Card title="Schemas" href="/hql/schema/schema-definition" icon="table">
        Learn about how to build your schema in HelixQL.
    </Card>
    <Card title="Traversals" href="/hql/select/selectN" icon="right-left-large">
        Learn about how to traverse the graph in HelixQL.
    </Card>
    <Card title="Creating data" href="/hql/create/addN" icon="plus">
        Learn about how to create data in HelixQL.
    </Card>
    <Card title="Vector operations" href="/hql/updating" icon="share-nodes">
        Learn about how to perform vector operations in HelixQL.
    </Card>
    <Card title="Keyword search" href="/hql/keyword_search" icon="pencil">
        Learn about how to perform keyword search in HelixQL.
    </Card>
    <Card title="Properties" href="/hql/properties/property-access" icon="tags">
        Learn about how to access properties in HelixQL.
    </Card>
    <Card title="Conditionals" href="/hql/conditionals/conditions" icon="ballot-check">
        Learn about how to use conditionals in HelixQL.
    </Card>
    <Card title="Result operations" href="/hql/result_ops" icon="integral">
        Learn about how to perform result operations in HelixQL.
    </Card>
    <Card title="Output values" href="/hql/output_values" icon="arrow-right-from-bracket">
        Learn about how to output values in HelixQL.
    </Card>
    <Card title="Types" href="/hql/types" icon="text-size">
        Learn about the types of HelixQL.
    </Card>
    <Card title="Errors" href="/hql/errors/E101" icon="triangle-exclamation">
