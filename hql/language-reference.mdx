...
<Warning>
**HelixQL is deprecated in HelixDB v2.** Queries are now written with the [Rust DSL](https://docs.rs/helix-enterprise-ql/latest/helix_dsl/) and dispatched as JSON — see the [Querying](/database/querying) guide. This section is kept as a reference for legacy HelixQL projects.
</Warning>
...
See [What is HelixQL?](/hql/hql) for more details.
...
See [Output Values](/hql/output_values) for more details.
...
See [Helix Types](/hql/types) for more details.
...
See [Schema Definition](/hql/schema/schema-definition) for more details.
...
See [Secondary Indexing](/hql/schema/indexing) for more details.
...
See [Unique Indexes](/hql/schema/unique-index) for more details.
...
See [Default Values](/hql/schema/default) for more details.
...
See [Create Nodes](/hql/create/addN) for more details.
...
See [Select Nodes](/hql/select/selectN) for more details.
...
See [Upsert Nodes](/hql/create/upsertN) for more details.
...
See [Create Edges](/hql/create/addE) for more details.
...
See [Select Edges](/hql/select/selectE) for more details.
...
See [Upsert Edges](/hql/create/upsertE) for more details.
...
See [Create Vectors](/hql/create/addV) for more details.
...
See [Select Vectors](/hql/select/selectV) for more details.
...
See [Upsert Vectors](/hql/create/upsertV) for more details.
...
See [Embedding Vectors](/hql/vectors/embedding) for more details.
...
See [Traversals From Nodes](/hql/traversals/steps_nodes) for more details.
...
See [Traversals From Edges](/hql/traversals/steps_edges) for more details.
...
See [Conditional Steps](/hql/conditionals/conditions) for more details.
...
See [Multiple Conditional Steps](/hql/conditionals/mult-conditions) for more details.
...
See [Result Operations](/hql/result_ops) for more details.
...
See [Group By](/hql/operations/group-by) for more details.
...
See [Aggregations](/hql/operations/aggregate-by) for more details.
...
See [Property Access](/hql/properties/property-access) for more details.
...
See [Property Exclusion](/hql/properties/property-exclusion) for more details.
...
See [Property Remappings](/hql/properties/property-remappings) for more details.
...
See [Property Additions](/hql/properties/property-additions) for more details.
...
See [Updating Items](/hql/updating) for more details.
...
See [Delete Operation](/hql/deleting) for more details.
...
See [Vector Search](/hql/vectors/searching) for more details.
...
See [Keyword Search](/hql/keyword_search) for more details.
...
See [RerankRRF](/hql/rerankers/rerank-rrf) for more details.
...
See [RerankMMR](/hql/rerankers/rerank-mmr) for more details.
...
See [Shortest Path Algorithms](/hql/traversals/shortest-paths/overview) for more details.
...
See [ShortestPathBFS](/hql/traversals/shortest-paths/shortest-path-bfs) for more details.
...
See [ShortestPathDijkstras](/hql/traversals/shortest-paths/shortest-path-dijkstra) for more details.
...
See [ShortestPathAStar](/hql/traversals/shortest-paths/shortest-path-astar) for more details.
...
See [Custom Weight Calculations](/hql/traversals/shortest-paths/custom-weights) for more details.
...
See [FOR Loops](/hql/control-flow/for-loops) for more details.
...
See [FOR Loop Destructuring](/hql/control-flow/for-destructuring) for more details.
...
See [Arithmetic Functions](/hql/functions/arithmetic) for more details.
...
See [Unary Math Functions](/hql/functions/unary-math) for more details.
...
See [Trigonometric Functions](/hql/functions/trigonometry) for more details.
...
See [Mathematical Constants](/hql/functions/constants) for more details.
...
See [Aggregate Functions](/hql/functions/aggregate-functions) for more details.
...
See [Model Macro](/hql/macros/model-macro) for more details.
...
See [MCP Macro](/hql/macros/mcp-macro) for more details.
