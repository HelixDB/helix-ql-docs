---
title: "Graph-Vector Database Performance Benchmarks (2025)"
description: "Benchmark results for HelixDB, Neo4j, and Postgres on a realistic graph dataset."
icon: "chart-bar"
sidebarTitle: "v1 - 2025"
---
...
![PointGet Performance](../images/pointget_combined.png)

![PointGet FixedQPS](../images/pointget_fixedqps.png)
...
![OneHop Performance](../images/onehop_combined.png)

![OneHop FixedQPS](../images/onehop_fixedqps.png)
...
![OneHopFilter Performance](../images/onehopfilter_combined.png)

![OneHopFilter FixedQPS](../images/onehopfilter_fixedqps.png)
